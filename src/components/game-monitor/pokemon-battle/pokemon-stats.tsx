...
export const PokemonStats = ({opponentState, isOpponent}: {opponentState: Character, isOpponent: boolean}) => {
  ...
  return (
    <div className={`pokemon-stats ${isOpponent ? "is-opponent" : "is-player"}`}>
