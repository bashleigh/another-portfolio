...
export const workexperience: WorkExperience[] = [
  ...
  },
  {
    ...
    exert:
      "As a freelancer I had various clients that I worked with to build and maintain their unique solutions.",
  },
  {
    startDate: {
      month: "05",
  ...
  },
  {
    ...
    company: "Wi-Q",
    description: [
      "At Wi-Q I develop micro services using TypeScript, PHP with symfony and Nodejs to deliver emails, url shortening, link click tracking, machine learning Facebook messenger bot to answer questions with defined answers. I also architected their promotion handling system and their batch action/job system for handling several tasks simultaneously.",
  ...
  },
  {
    ...
    description: [
      ...
      "I'm now in a position where I'm planning, scheduling and applying new projects and systems within my deadlines and communicating with my clients and colleagues. Whilst at Ansta I used PHP, Laravel, Lumen, a Custom PHP framework, A custom PWA framework, Debian, CentOS, React, bootstrap, React-Native, Expo and produced a dynamic web page for Stamford Bridge's stadium displays.",
    ],
    exert:
